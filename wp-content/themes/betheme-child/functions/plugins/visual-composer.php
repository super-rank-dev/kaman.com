...
if (! function_exists('mfn_vc_integrateWithVC')) {
	function mfn_vc_integrateWithVC()
	{
		...
		vc_map(array(
			'base' => 'certifications_and_accreditation',
			'name' => __('Certifications and Accreditation', 'mfn-opts'),
			'category' => __('Muffin Builder', 'mfn-opts'),
			'icon' => 'mfn-vc-icon-article_box',
			'params' => array(
				array(
					'param_name' => 'c_and_a_title',
					'type' => 'textfield',
					'heading' => __('Title', 'mfn-opts'),
					'admin_label'	=> true,
				),
				array(
					'param_name' => 'c_and_a_sub_title',
					'type' => 'textfield',
		...
		vc_map(array(
			...
			'params' 		=> array(
				...
				array(
					'param_name' 	=> 'product_short_description',
					'type' 			=> 'textarea',
				...
				array(
					...
					'type' 			=> 'textfield',
					'heading' 		=> __('Link Button Label', 'mfn-opts'),
					'admin_label'	=> true,
				),
