...
$( document.body ).on( 'added_to_cart', function( e ) {
  ...
  var productvariations = {
    ...
    triggerChange: function(atr, nval) {
        ...
        if( $('.mfn-vr-options:not(.attribute_'+atr+') li').length )
            $('.mfn-vr-options:not(.attribute_'+atr+') li a').css('opacity', '0.3');

        if( $('.mfn-vr-select:not(.attribute_'+atr+') option').length )
            $('.mfn-vr-select:not(.attribute_'+atr+') option').css('opacity', '0.3');
        ...
        $('.woocommerce div.product form.cart .variations select option').each(function() {
            ...
            if($('.woocommerce .mfn-variations-wrapper .mfn-vr select.'+attr_name).length)
                $('.woocommerce .mfn-variations-wrapper .mfn-vr select.'+attr_name+' option[value="'+val+'"]').css('opacity', '1');
        });
