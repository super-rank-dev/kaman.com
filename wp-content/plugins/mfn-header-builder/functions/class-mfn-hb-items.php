...
class Mfn_HB_Items {
	...
	public static function menu( $attr ){
		...
		$output = '<div class="mhb-item-inner '. esc_attr( $replaceWithMenuIcon ) .'">';
			...
			$output .= '<a class="mobile-menu-toggle" aria-label="Menu" href="#"><i class="icon-menu-fine"></i></a>';
	...
	public static function menu_icon( $attr ){
		...
		$output = '<a class="open-menu-icon" aria-label="Menu" href="#"><i class="icon-menu-fine"></i></a>';
	...
	public static function extras( $attr ){
		...
		if( 'hide' != $searchStyle ){
			...
			$output .= '<div class="search '. esc_attr( $searchStyle ) .'">';
				...
				if( $searchStyle == 'icon' ){
					$output .= '<a class="search-icon" aria-label="Search" href="#"><i class="icon-search-fine"></i></a>';
				}

				$output .= '<form method="GET" action="'. esc_url( home_url( '/' ) ) .'">';

					$output .= '<i class="icon-search-fine"></i>';
					$output .= '<label for="s" class="visually-hidden">Search</label>';
