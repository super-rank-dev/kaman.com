 ...
 */
function vc_mega_footer_get_max( $array ) {

	return VC_Mega_Footer_Globals::get_max( $array );
 ...
 */
function vc_mega_footer_get_svg( $svg ) {

	return VC_Mega_Footer_Globals::get_svg( $svg );
 ...
 */
function vc_mega_footer_get_template( $name ) {

	return VC_Mega_Footer_Globals::get_template( $name );

}

class VC_Mega_Footer_Globals {
	 ...
	 */
 	public static function get_template( $name ) {
		 ...
		 */
		apply_filters( 'vc-mega-footer-template-paths', $locations );
